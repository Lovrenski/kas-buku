...
<div class="row col-4">
	...
	<button type="button" class="btn btn-danger m-1 mb-2" data-bs-toggle="modal" data-bs-target="#detailLaporan">Laporan
		Pengeluaran <i class="bi bi-printer"></i></button>
</div>
<div class="row">
								...
								<td class="border-bottom-0">
									...
									<div class="modal fade" id="delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Pengeluaran
													</h1>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<div class="modal-body">
												...
												<div class="modal-footer">
													...
													<a href="<?= base_url('pengeluaran/delete/' . $u['id_transaksi']) ?>" class="btn btn-danger">Delete</a>
												</div>
											</div>
										</div>
									</div>
...
<div class="modal fade" id="detailLaporan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('pdfview/pengeluaran') ?>" method="POST">
					<div class="mb-3">
